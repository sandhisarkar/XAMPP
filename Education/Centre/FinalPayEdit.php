...
mysqli_select_db( $con,"fees_collection");
	$sql="UPDATE fees_collection SET course_fees='".$course_amount."',total_pay_amount = '".$tot_pay_amount."' WHERE student_id='".$get_stu_ID."'  and pay_period= '".$paying_period."' and discount = '".$get_dis."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Fees Collection : </h1>
										<form action="FinalPayEdit.php?student_id=<?php echo  $get_stu_ID?>" method="post">
