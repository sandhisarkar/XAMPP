...
if(isset($_REQUEST["centre_sub"]))
{
	mysqli_select_db( $con,"course_details");
	 ...
	 $query=mysqli_query($con ,"select MAX(id) from course_details");
	 ...
	 $course_name_temp=$_POST['course_name'];
	 $course_name= strtoupper ($course_name_temp);
	 
	 $course_id_temp1 = substr($course_name,0,4);
	 $course_id_temp2 = str_pad($gencID,4,"0",STR_PAD_LEFT);
	 $course_id = $course_id_temp1."/".$course_id_temp2;
	 
	 
	 $course_price = $_POST['course_price'];
	 
	 $sql="INSERT INTO course_details (id,course_id,course_name,course_price) VALUES ('".$gencID."','".$course_id."','".$course_name."','".$course_price."')";

		if (!mysqli_query($con,$sql))
		{
		  //die('Error: ' . mysqli_error());
		  $msgNav = "Error Creating new Course";
		}
		else
		{
		  //echo "1 record added";
		  $msgNav = "New Course Created";
		}
					...
					<div class="container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: 10%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Add New Course : </h1>
									
									<div class="col-sm-6">
										<form action="Course.php" method="post" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px;">
											<table>
												<tr>
													<td>
														<font style="color:White; margin-left:50px; font-family: Verdana;  margin-top:15px; font-size:17px;">Course Name : &nbsp;&nbsp;&nbsp;</font> 
														<input type="text" id="course_name" name="course_name"  required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 250px;text-transform: uppercase;">
												...
												<tr>
													<td>
														...
														<input type="number" id="course_price" name="course_price" min="0" required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 215px;text-transform: uppercase;"><span style = "color:white;"> Rs. /- </span>
