...
{
   $sql="Delete from centre_details where cen_id = '".$get_cen_ID."'";

	if (!mysqli_query($con,$sql))
	{
	  //die('Error: ' . mysqli_error());
	  $msgNav = "Error in deleting the centre";
    }
	else
	{
	  //echo "1 record added";
	  $msgNav = "Centre is deleted successfully";
	}
					...
					<div class="container-fluid">
                            <div class="row" style = "width: 100%;">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -3%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Centre Details : </h1>
									
									<div class="col-sm-12">
										
											<table style="width:110%; font-size: larger;">
												<tr style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;font-size: x-large;">
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Centre ID</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Centre Name</th> 
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Centre Address</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;"> State</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;"> Pincode</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;"> Location</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Contact Person</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Contact No</th>	
													
												</tr>
												<?php
															mysqli_select_db( $con,"centre_details");

															$sql = "SELECT cen_id,cen_name,cen_address,cen_state,cen_pin,cen_location,per_name,per_phone,per_email_address FROM centre_details";
															...
															if (mysqli_num_rows($result) > 0) {
																...
																while($row = mysqli_fetch_assoc($result)) {
																	...
																	<td style = "padding: 5px;"><?php echo  $row["cen_id"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["cen_name"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["cen_address"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["cen_state"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["cen_pin"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["cen_location"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["per_name"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["per_phone"]?></td>
																	
																	<td style = "padding: 5px;"><a href="CentreEdit.php?cen_id=<?php echo  $row["cen_id"]?>"><i class="fas fa-edit" style="font-size:25px"></i></a></td>
																	<td style = "padding: 5px;"><a href="CentreInfo.php?cen_id=<?php echo  $row["cen_id"]?>"><i class='fas fa-trash-alt' style='font-size:25px'></a></i></td>
																	<tr>
