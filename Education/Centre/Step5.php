...
$cen_pin = $stat['cen_pin'];
	...
	$past_edu_agg = $_POST['agg'];
	 ...
	 $sql="UPDATE admission_details SET past_board='".$past_board."',eng_marks = '".$eng_marks."',ls_marks='".$ls_marks."',ps_marks = '".$ps_marks."',math_marks='".$math_marks."',past_edu_agg='".$past_edu_agg."',status='".$status."',created_dttm='".$created_date."' WHERE student_id='".$stu_id."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step6.php?stu_id=<?php echo  $stu_id?>" method="post">
												...
												<tr>
													<td>
														...
														<input required = "true" type="text" id="present_school" name="present_school"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
												...
												<tr>
													<td>
														...
														<input required = "true" type="text" id="present_board" name="present_board"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;margin-bottom: 14px;">
