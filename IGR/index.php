...
if(isset($_REQUEST["u_sub"]))
{
 ...
 if($usr!=''&&$pwd!='')
 {
   ...
   $query1=mysqli_query($con ,"select * from ac_user a, ac_user_role_map b where a.user_id='".$usr."' and a.user_pwd='".$pwd."' and a.user_id = b.user_id and b.role_id = '8'");
...
<html>
    <head>
		...
		<link href="BZer.ico" rel="apple-touch-icon">
    ...
    <body  style="background-image:url('./images/final_screen1.jpg'); background-size: cover; background-repeat: no-repeat;" >
