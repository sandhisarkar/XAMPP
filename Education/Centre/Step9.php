...
$cen_pin = $stat['cen_pin'];
	...
	$created_date = date("Y-m-d");
	 ...
	 $sql="UPDATE admission_details SET student_course='".$course_name."',student_class = '".$class_for."',ad_start_date='".$ad_start_date."',ad_end_date='".$ad_end_date."',discount='".$dis."',status='".$status."',created_dttm='".$created_date."' WHERE student_id='".$stu_id."'";
