...
$pdf->Output('Centre_Fee_'.$_GET["centre_location"].'-'.$_GET["centre_name"].'.pdf','D');
}
if($type == 'csv')
{
	mysqli_select_db( $con,"admission_details");
	...
	$filename = "Centre_Fee_".$_GET["centre_location"].'-'.$_GET["centre_name"].".csv";
