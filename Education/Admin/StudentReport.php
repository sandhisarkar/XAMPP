					...
					<div class="container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: -5%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Student Details Report : </h1>
									
										<div class="col-sm-7" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 225px;">
											<form action="StudentDetailsPdf.php" method="get">
											<table>
												...
												<tr>
													<td>
														<font style="color:White; margin-left:55px; font-family: Verdana;  margin-top:15px; font-size:17px;">Search by Student ID : &nbsp;&nbsp;&nbsp;</font> 
												...
												<tr>
													<td>
														<input class="toggle btn btn-primary" type="submit" id="centre_sea" name = "centre_sea" value="Generate Report" style="color:White; margin-left:235px; font-family: Verdana;  margin-top:50px; font-size:17px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
													</td>
												</tr>
