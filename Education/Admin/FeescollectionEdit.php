...
$get_fees_id = $_GET["fees_id"];

$q1=mysqli_query($con,"select student_course,course_fees,discount from admission_details where student_id = '".$get_stu_ID."'");
$n1=  mysqli_fetch_assoc($q1);

$course_name = $n1['student_course'];
$course_fees = $n1['course_fees'];
$discount = $n1['discount'];

$q2=mysqli_query($con,"select discount,pay_date,pay_period from fees_collection where student_id = '".$get_stu_ID."' and id = '".$get_fees_id."' ");
$n2=  mysqli_fetch_assoc($q2);

$fetch_dis = $n2['discount'];
$fetch_pay_date = $n2['pay_date'];
					...
					<div class="container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;">Edit Fees Collection : </h1>
										<form action="CollectFeesEdit.php?student_id=<?php echo  $get_stu_ID?>&fees_id=<?php echo $get_fees_id?>" method="post">
										<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;">
											
												
											<table>
												<tr>
													<td><p style = "color:white;"><u>Course Details</u></p></td>
												</tr>
												
												<tr>
													<td>
														<font style="color:White; margin-left:113px; font-family: Verdana;  margin-top:15px; font-size:17px;">Course : &nbsp;&nbsp;&nbsp;</font> 
														<!--input type="dropdown" id="centre_state" name="centre_state"  required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 250px;"-->		
															<select required="true" id="course_name" name="course_name" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
																	<option selected value="" disabled>Select any course</option>
																	<option readonly selected><?php echo $course_name ?></option>
															</select>
													</td>
												</tr>
												...
												<tr>
													<td>
														...
														<input readonly value = "<?php echo $course_fees ?>" required="true" type="text" id="course_fees" name="course_fees"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;text-transform: uppercase;">
												...
												<tr>
													<td>
														<font style="color:White; margin-left:30px; font-family: Verdana;  margin-top:15px; font-size:17px;">Discount Percent : &nbsp;&nbsp;&nbsp;</font> 
														<input value = "<?php echo $fetch_dis?>" required = "true" min="0" max="25" type="number" id="dis" name="dis"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
												...
												<tr>
													<td>
														<font style="color:White; margin-left: 40px; font-family: Verdana;  margin-top:15px; font-size:17px;">Pay Month-Year : &nbsp;&nbsp;&nbsp;</font> 
														<input value = "<?php echo $fetch_pay_date?>" required="true" type="date" id="pay_month_year" name="pay_month_year"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;text-transform: uppercase;">
