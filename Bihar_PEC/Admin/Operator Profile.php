...
if(isset($_POST["update_profile"]))
{
    ...
    $dobdate = substr($_POST['dob'],8,2);
	$dobmonth = substr($_POST['dob'],5,2);
	$dobyear = substr($_POST['dob'],0,4);
	$dob =  $dobdate."/".$dobmonth."/".$dobyear;

$sql="UPDATE operator_profile SET district_name='".$_POST['dis_name']."',state_name = '".$_POST['state_name']."',centre_name='".$_POST['centre_name']."',operator_name = '".$_POST['operator_name']."',station_id='".$_POST['station_id']."',father_name='".$_POST['father_name']."',dob = '".$dob."' WHERE sl_no='".$op_sl."' AND operator_id = '".$opid."'";
  ...
  <body>
			...
			<div class="col-sm-12" style = "margin-top:0%;">
				...
				<div class="col-sm-12" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<?php
						...
						if($msgNav == "Error")
						{
							header("refresh:1;url=Operator Profile.php" );	
						...
						if($msgNav == "Success")
						{
							header("refresh:15;url=Operator Profile.php" );	
							echo '<div class="spinner-grow spinner-grow-sm"> </div><span> &nbsp;&nbsp;&nbsp;</span>';
							echo '<label class="text-success">Operator is Updated. . . Showing Result for Operator ID :-  <u>'.$opid.'</u></label></br>';
							$distname = $_POST['dis_name'];
							$state = $_POST['state_name'];
							$centrename = $_POST['centre_name'];
							$opname = $_POST['operator_name'];
							$dob = $_POST['dob'];
							$fathername = $_POST['father_name'];
							$stid = $_POST['station_id'];
						}
					?>
					<ul class="pagination pagination-lg" style="display: inline flow-root list-item; padding-bottom: 1%;">
						<li class="active"><a onclick= "openOverlay()" href="Operator Profile.php?Handle=<?php echo  $op_sl ;?>" data-toggle="tooltip" title="Operator Profile" data-placement="left"><i class="fa fa-user-o" aria-hidden="true"></i></a></li>
						<?php
				...
				<div class="col-sm-12" style = "text-align: center; margin-left: auto;margin-right: auto;">
					<center>
						<form  action = "Operator Profile.php?Handle=<?php echo  $op_sl;?>" method ="post"  id = "export_excel" enctype="multipart/form-data">
								<div class="col-sm-4">
									<div class="input-group mb-3">
										<div class="input-group-append">
											  <span class="input-group-text" style="background-color:transparent;border:0;">District Name :</span>
										</div>
										
										<input value ="<?php echo $distname;?>" class="form-control" readonly= "true" type="text" id="dis_name" name="dis_name" required="true" placeholder ="Enter District Name" autocomplete="off" style ="background-color: ghostwhite;border-radius: 5px;" autofocus></input>
									 </div>
								</div>
								<div class="col-sm-4">
									<div class="input-group mb-3">
										<div class="input-group-append">
											  <span class="input-group-text" style="margin-left:13px;background-color:transparent;border:0;">State Name :</span>
										</div>
										<input value ="<?php echo $state;?>"  class ="form-control" readonly= "true" type="text" id="state_name" name="state_name" required="true" placeholder ="Enter State Name"autocomplete="off" style ="background-color: ghostwhite;border-radius: 5px;" autofocus></input>
								...
								<div class="col-sm-4">
									<div class="input-group mb-3">
										<div class="input-group-append">
											  <span class="input-group-text" style="margin-left:3px;background-color:transparent;border:0;">Centre Name :</span>
										</div>
										<input value ="<?php echo $centrename;?>" readonly= "true" class ="form-control" type="text" id="centre_name" name="centre_name" autocomplete="off" placeholder ="Enter Centre Name" required="true" style ="background-color: ghostwhite;border-radius: 5px;" autofocus></input>
								...
								<div class="col-sm-4">
									<div class="input-group mb-3">
										<div class="input-group-append">
											  <span class="input-group-text" style="margin-left:-15px;background-color:transparent;border:0;">Operator Name :</span>
										</div>
										<input value ="<?php echo $opname;?>"  class="form-control" type="text" id="operator_name" name="operator_name" autocomplete="off" placeholder ="Enter Operator Name" required="true" style ="border-radius:5px;" autofocus></input>
								...
								<div class="col-sm-4">
									<div class="input-group mb-3">
										<div class="input-group-append">
											  <span class="input-group-text" style="margin-left:-23px;background-color:transparent;border:0;">Operator's D.O.B :</span>
										</div>
										<input value ="<?php echo $dob;?>" class="form-control" type="date" id="dob" name="dob" autocomplete="off" placeholder ="Enter Operator's Date of Birth" required="true" style ="border-radius:5px;" autofocus></input>
								...
								<div class="col-sm-4">
									<div class="input-group mb-3">
										<div class="input-group-append">
											  <span class="input-group-text" style="margin-left:-5px;background-color:transparent;border:0;">Father's Name :</span>
										</div>
										<input value ="<?php echo $fathername;?>" class="form-control" type="text" id="father_name" name="father_name" autocomplete="off" placeholder ="Enter Father's Name" required="true" style ="border-radius:5px;" autofocus></input>
								...
								<div class="col-sm-4">
									<div class="input-group mb-3">
										<div class="input-group-append">
											  <span class="input-group-text" style="margin-left:27px;background-color:transparent;border:0;">Station ID :</span>
										</div>
										<input value ="<?php echo $stid;?>" class="form-control" pattern = "^\d{5}$" type="text" id="station_id" name="station_id" autocomplete="off" placeholder ="Enter Operator's Station ID"  style ="border-radius:5px;" autofocus></input>
										
									 </div>
								</div>
								<input class="toggle btn btn-primary" onclick="uploadme()" type="submit" id="update_profile" name = "update_profile" value="Update Operator Profile" style="font-family: Verdana;  margin-top:15px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
	...
	<script>
		...
		function uploadme()
		{
			...
			var res = patt.test(station_id);
			
			
			if(operator_name !== "" && dob !== ""  && father_name !== "" && station_id !== "" && res == true)
			{
				document.getElementById("overlay").style.display = "block";
