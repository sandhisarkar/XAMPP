...
$cen_location = $stat["cen_location"];
	...
	$cen_pin = $stat['cen_pin'];
	 ...
	 $query=mysqli_query($con ,"select MAX(id) from admission_details where centre_id = '".$stcen_id."'");
	...
	$sql="INSERT INTO admission_details (id,centre_id,centre_name,centre_location,student_id,student_name,student_dob,student_gender,status,created_dttm) VALUES ('".$genStuID."','".$stcen_id."','".$cen_name."','".$cen_location."','".$stu_id."','".$student_name."','".$student_dob."','".$gender."','".$status."','".$created_date."')";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step3.php?stu_id=<?php echo  $stu_id?>" method="post">
