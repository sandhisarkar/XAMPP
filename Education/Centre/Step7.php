...
$sta=mysqli_query($con,"select cen_id,user_name,cen_name,cen_location,cen_address,cen_state,cen_pin from centre_details where cen_id='".$_SESSION['user']."'");
...
$cen_address = $stat['cen_address'];
$cen_state = $stat['cen_state'];
$cen_pin = $stat['cen_pin'];
	...
	$additioanl_number = strtoupper($_POST['additioanl_number']);
	 ...
	 $sql="UPDATE admission_details SET id_proof='".$id_proof."',additioanl_number = '".$additioanl_number."',status='".$status."',created_dttm='".$created_date."' WHERE student_id='".$stu_id."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step8.php?stu_id=<?php echo  $stu_id?>" method="post" enctype="multipart/form-data">
