                        ...
                        if($enablestat == true || $enablestat == false) 
                        {
                            ...
                            <label>Choose Operator Id </label>
                                <select enable ="<?php $enablestat; ?>" required ="true" placeholder="Choose Operator" id="operator" name="operator" autofocus class="form-control">
                                    ...
                                    $sql = "SELECT Distinct(operator_id) FROM tbl_operator where state = '".$state."' and emp_status <> 0 order by operator_id ASC";
                        ...
                        if($enablestat == true || $enablestat == false) 
                        {
                            ...
                            <label>Choose Operator Id </label>
                                <select enable ="<?php $enablestat; ?>" required ="true" placeholder="Choose Operator" id="operator" name="operator" autofocus class="form-control">
                                    ...
                                    $sql = "SELECT Distinct(operator_id) FROM tbl_operator where state = '".$state."' and district = '".$district."' and emp_status <> 0 order by operator_id ASC";
                                    $result = mysqli_query($con, $sql);
                                    if (mysqli_num_rows($result) > 0) {
                                    // output data of each row
