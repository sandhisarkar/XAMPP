...
if(isset($_POST["sub_app_search"]))
{
    ...
    $datestartapplication = date("Y-m-d",strtotime("-7 days"));
    ...
    //{
        ...
        //{
			...
			if($district == "All")
			{
				...
				$result=mysqli_query($con ,"SELECT distinct(a.operator_id) from tbl_outrangetime a, tbl_attendance b where a.operator_id = b.operator_id and b.state = '".$state."' and a.created_date BETWEEN '".$datestartapplication."' and '".$dateendapplication."' ");
                $count = 0;
			...
			{
				$created_dttm = $year."-".$month."-".$day;
				$result=mysqli_query($con ,"SELECT distinct(a.operator_id) from tbl_outrangetime a, tbl_attendance b where a.operator_id = b.operator_id and b.state = '".$state."' and b.district = '".$district."' and a.created_date BETWEEN '".$datestartapplication."' and '".$dateendapplication."' ");
                $count = 0;
                while($row = mysqli_fetch_row($result))
                {
                    $op = $row[0];
              ...
              <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                ...
                <li class="active"><a href="#exampledropdownDropdown2" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user-o"></i>Most Occurred</a>
                  <ul id="exampledropdownDropdown2" class="collapse list-unstyled ">
                    <li class="active"><a href="Occured Time.php" onclick="openOverlay()"> <i class="fa fa-calendar text-danger"></i>Out Of Time</a></li>
      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Most Occurred Out of Time</li>
          </ul>
        </div>
      </div>
      <section class="forms">
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Most Occurred Out of Time Wise Report (Every 7 Days) . . .</h1>
            <p>(Search result with specific most occurred out of time)</p>
          </header>
          <div class="row">
            <div class="col-lg-4">
            </div>
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                  <h4>Search Details (Every 7 Days) </h4>
                </div>
                <div class="card-body">
                  <p>(Details report for specific most occurred out of time)</p>
                  <?php
                  if($role == 1)
                  {
                    ?>
            ...
            if($success == "Change")
            {
                ...
                echo '<label class="text-success">Reporting for Operator ID - '.$operator_id.' is Updated for Date - '.$dateapplication.'</label>';
						...
						if($success == "Exists")
						{
                            ...
                            //echo $output;
                            ?>
								<form style="border-style: none;" action = "genMostTime.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
