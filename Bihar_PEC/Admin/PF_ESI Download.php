...
if(isset($_POST["sub_excel"]))
{
	...
	$q1=mysqli_query($con,"select DISTINCT pf_doc, esi_doc from salary_month_details where month_year = '".$month_yr."' AND pf_esi_challan_status = 'Completed'");
	$n1=  mysqli_fetch_row($q1);
	//echo $query;
	$pf_doc= $n1[0];
	$esi_doc= $n1[1];
	//echo strlen($pf_doc);
	$pf_doc = substr($pf_doc,6,strlen($pf_doc)-6);
	$esi_doc = substr($esi_doc,6,strlen($esi_doc)-6);
	
	if($pf_doc != null && $esi_doc != null) 
	{
		$msgNav = "Success";
...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>PF/ESI Challan Download</u> (Monthly)</h2>
			...
			<div class="col-sm-12" style = "margin-top:5%;">
				...
				<div class="col-sm-6" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<center>
						...
						<form  action = "PF_ESI Download.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
							<table>
								...
								<td style = "text-align: center;margin-left: auto;margin-right: auto;">
									...
									<select required="true" id="month_year" name="month_year" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 300px;">
										...
										<?php
											...
											$sql = "SELECT DISTINCT(month_year) FROM salary_month_details where pf_esi_challan_status  = 'Completed'";
				...
				<div class="row" style="margin-top: 5%;">
					<?php
						...
						if($msgNav == "Success")
						{
							...
							<div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-search text-info"></i> Showing PF/ESI Challan . . .  </i></h6>
								<h5>Month-Year : <u><b><?php  echo $month_yr;?></b></u> <i class="fa fa-calendar text-info"></i></h5>
								
							  </div>
						  </div>
						  <div class="col-md-6  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-file text-warning"></i> Download PF Challan . . .  </i></h6>
								<button class="btn btn-primary" style="background: green;"> <a href="<?php echo $pf_doc;?>" style ="color: white;" download="PF_<?php echo $month_yr;?>.pdf">Download <i class="fa fa-download" style ="color: white;"></i></a></button>
							  </div>
						  </div>
						  <div class="col-md-6  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-file text-warning"></i> Download ESI Challan . . .  </i></h6>
								<button class="btn btn-primary" style="background: green;"> <a href="<?php echo $esi_doc;?>" style ="color: white;" download="ESI_<?php echo $month_yr;?>.pdf">Download <i class="fa fa-download" style ="color: white;"></i></a></button>
							  </div>
						  </div>
						  <?php
							//echo $output;
