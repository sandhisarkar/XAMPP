...
if(isset($_POST["sub_excel"]))
{
	...
	$q1=mysqli_query($con,"select DISTINCT district_name,doc from monthly_attendence where month_year = '".$month_yr."' ");
	...
	if($dist != null && $cus_bill_doc != null) 
	{
		$msgNav = "Success";
...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>Verify Attendance Document</u> (Monthly)</h2>
			...
			<div class="col-sm-12" style = "margin-top:5%;">
				...
				<div class="col-sm-6" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<center>
						...
						<form  action = "Verify Attendence.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
							<table>
								...
								<td style = "text-align: center;margin-left: auto;margin-right: auto;">
									...
									<select required="true" id="month_year" name="month_year" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 300px;">
										...
										<?php
											...
											$sql = "SELECT DISTINCT(month_year) FROM monthly_attendence order by month_year ASC";
				...
				<div class="row" style="margin-top: 5%;">
					<?php
						...
						if($msgNav == "Success")
						{
							...
							<div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-search text-info"></i> Showing Attendance Document . . .  </i></h6>
								<h5>Month-Year : <u><b><?php  echo $month_yr;?></b></u> <i class="fa fa-calendar text-success"></i></h5>
								
							  </div>
							</div>
							<?php
								$q1=mysqli_query($con,"select DISTINCT district_name from monthly_attendence where month_year = '".$month_yr."' ");
								while($row = mysqli_fetch_row($q1)) {
									$dist = $row[0];
									$q2=mysqli_query($con,"select DISTINCT doc from monthly_attendence where month_year = '".$month_yr."' AND district_name = '".$dist."' ");
									while($row1 = mysqli_fetch_row($q2)){
										...
										{
										?>
										<div class="col-md-4  wow bounceInUp" data-wow-duration="2.4s">
											  <div class="box" >
												<h6><i class="fa fa-file text-info"></i> Download Attendance Document . . .  </h6>
												<h6><i class="fa fa-map text-warning"></i> District - <u><?php echo $dist;?></u>  </i></h6>
												<button class="btn btn-primary" style="background: green;"> <a href="<?php echo $cus_bill_doc;?>" style ="color: white;" download="Attendance_<?php echo $dist;?>_<?php echo $month_yr;?>.pdf">Download <i class="fa fa-download" style ="color: white;"></i></a></button>
											  </div>
										  </div>
										  <?php
