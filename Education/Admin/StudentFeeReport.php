					...
					<div class="container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: -5%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Report for Fees Collection(Student Wise) : </h1>
									
										<div class="col-sm-7" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 225px;">
											<form action="StudentFeePdf.php" method="get">
											<table>
												...
												<tr>
													<td>
														<font style="color:White; margin-left:86px; font-family: Verdana;  margin-top:15px; font-size:17px;">File Type : &nbsp;&nbsp;&nbsp;</font> 
