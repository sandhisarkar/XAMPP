...
session_start();
error_reporting(0);
header("refresh:120;url=Vendor Details.php" );
...
$q_cou=mysqli_query($con,"select COUNT(*) from vendor_details");
...
{
	$sql="Delete from vendor_details where sl_no = '".$get_ID."'";
		...
		else
		{
			...
			if($tot > 0)
			{
				$sql1 = "SELECT sl_no from vendor_details order by sl_no";
				...
				while($row1 = mysqli_fetch_row($result1)) {
					$temp_sl = $row1[0];
					//echo $temp_sl;
					$sql="UPDATE vendor_details SET sl_no = '".$i."' WHERE sl_no='".$temp_sl."'";
					if (!mysqli_query($con,$sql))
					{
...
<html lang="en">
  ...
  <body>
	<script>
        ...
        <h2 class="mb-4"><u>Vendor Details</u></h2>
				...
				<div class="col-sm-12" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<?php
															...
															if($msgNav == "Delete")
															{
																...
																echo '<label class="text-success">Deleted Successfully</label>';
															...
															$sql = "SELECT sl_no,vendor_name,vendor_code,vendor_address,contact_person,contact_details,person_mail,GSTN,outsourcing_rate,status FROM vendor_details ORDER BY sl_no";
															...
															if (mysqli_num_rows($result) > 0) {
																...
																<table class="table table-hover table-bordered table-striped" border ='1' width='100%' style = "text-align: center; overflow-x:auto;font-size: x-small;">
																	...
																	<tr>
																		...
																		<th style = 'padding:auto;'>Vendor Name</th>
																		<th style = 'padding:auto;'>Vendor Code</th>
																		<th style = 'padding:auto;'>Vendor Address</th>
																		<th style = 'padding:auto;'>Contact Person</th>
																		<th style = 'padding:auto;'>Person Phone</th>
																		<th style = 'padding:auto;'>Email</th>
																		<th style = 'padding:auto;'>GST Number</th>
																		<th style = 'padding:auto;'>Outsourcing Rate</th>
																...
																while($row = mysqli_fetch_assoc($result)) {
																	...
																	<tr>
																		...
																		<td style = "padding: auto;"><?php echo  $row["vendor_name"]?></td>
																		<td style = "padding: auto;"><?php echo  $row["vendor_code"]?></td>
																		<td style = "padding: auto;"><?php echo  $row["vendor_address"]?></td>
																		<td style = "padding: auto;"><?php echo  $row["contact_person"]?></td>
																		<td style = "padding: auto;"><?php echo  $row["contact_details"]?></td>
																		<td style = "padding: auto;"><?php echo  $row["person_mail"]?></td>
																		<td style = "padding: auto;"><?php echo  $row["GSTN"]?></td>
																		<td style = "padding: auto;"><?php echo  $row["outsourcing_rate"]?></td>
																...
																header("refresh:3;url=/Bihar_PEC/Admin");
																?>
	  ...
	  <div id="MyFirstModalId" class="modal fade" role="dialog">
		  <div class="modal-dialog">
			...
			<div class="modal-content">
			  ...
			  <h4 class="modal-title float-left">Delete Vendor !</h4>
		...
		<div id="MySecondModalId" class="modal fade bd-example-modal-sm" role="dialog">
		  <div class="modal-dialog">
			...
			<div class="modal-content">
			  <div class="modal-header">
			  <h4 class="modal-title float-left">Edit Vendor ! </h4>
				<button type="button" class="close" data-dismiss="modal">X</button>
	...
	function deleteme(delid)
	{
		if(confirm("Do you want to Delete ?")){
			window.location.href = 'Vendor Details.php?Handle=' +delid+'';
	...
	<script>
		...
		function editme()
		{
			...
			document.getElementById("overlay").style.display = "block";
				window.location.href = 'Vendor Edit.php?Handle=' +CurrentId+'';
				txt = "Edit Open";
	...
	function deleteme()
	{
		...
		var event = "Delete";
			window.location.href = 'Vendor Details.php?Handle=' +CurrentId+'&Event='+event+'';
