...
function viewTable($con)
{
	...
	$sql = "SELECT a.id,a.student_id,a.centre_name,a.course_id,a.centre_location,b.student_name,b.student_dob,b.student_gender,b.student_phone,b.student_class,b.student_course,a.course_fees,a.discount,a.total_pay_amount,a.pay_period FROM fees_collection a,admission_details b where a.centre_id = '".$stcen_id."' and a.created_dttm >= '".$_GET["start_date"]."' and a.created_dttm <= '".$_GET["start_end"]."' and a.student_id = b.student_id and a.student_id = '".$_GET["student_id"]."'";
