       ...
       //{
           ...
           if($district == "All")
           {
               ...
               while($stdt <= $enddt)
               {
                   ...
                   $sql_op_count = "SELECT COUNT(operator_id) from tbl_operator where (operator_id NOT IN (select operator_id from tbl_attendance where created_dttm ='".$disdt."' and  state = '".$state."') OR operator_id IN (select operator_id from tbl_attendance where created_dttm ='".$disdt."' and  state = '".$state."') ) and  (emp_status = 1 or emp_status = 2) and  state = '".$state."'";
  ...
  <body>
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-file-excel-o"></i>Report </a>
              <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                ...
                <li class="active"><a href="Attendance.php" onclick="openOverlay()"> <i class="fa fa-child"></i>Attendance</a></li>
    ...
    <div class="page">
      ...
      <section class="forms">
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Attendance report. . .</h1>
            <p>(Search result for specific state, district and date range)</p>
          </header>
          <div class="row">
            <div class="col-lg-4">
            </div>
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <p>(Details report for Attendance)</p>
            ...
            <div class="col-sm-12" style = "text-align: center; margin-left: auto;margin-right: auto;">
					<?php
						...
						if($success == "Exists")
						{
                            ...
                            //echo $output;
                            ?>
								<form style="border-style: none;" action = "genAttendance.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
									<div style="text-align: center;padding-bottom:10px;">
										<button id="gen_rep" name ="gen_rep" onclick = "uploadme()" type="submit" class="btn btn-primary"><i class="fa fa-file-excel-o"></i>&nbsp;&nbsp; Generate Report</button>
									</div>
								</form>
						...
						if($error == "Not Exists")
						{
							//header( "refresh:3;url=Operator.php" );
							echo '<div class="spinner-grow spinner-grow-sm"> </div><span> &nbsp;&nbsp;&nbsp;</span>';
							echo '<label class="text-danger">No Reporting result found ...</label>';
							//header( "refresh:3;url=Operator.php" );
						}
					?>
				</div>
    ...
    <script language ="javascript">
        function uploadme() {
            ...
            if(state !== null && district !== null && repstdate !== null && rependdate !==null)
            {
                document.getElementById("overlay").style.display = "block";
                return true;
            }
      ...
      <script>
        function uploadEditmeNormal(st,dis)
		{
          var state = st;
          var district = dis;
          ...
          if(state !== null && district !== "" )
          {
            
            document.getElementById("overlay").style.display = "none";
            var excel_data = $('#range_reporting_table').html();
            var page = "genDistrict.php?data="+excel_data;
