...
if(isset($_POST["sub_app_search"]))
{
    ...
    if($district == "All")
    {
      ...
      $result=mysqli_query($con ,"SELECT distinct(a.operator_id) from tbl_attendance a, tbl_operator b where a.operator_id = b.operator_id and a.state = '".$state."' and  a.dept = '".$location."' and a.created_dttm BETWEEN '".$datestartapplication."' and '".$dateendapplication."'  ");
    ...
    {
      $created_dttm = $year."-".$month."-".$day;
      $result=mysqli_query($con ,"SELECT distinct(a.operator_id) from tbl_attendance a, tbl_operator b where a.operator_id = b.operator_id and a.state = '".$state."' and a.district = '".$district."' and  a.dept = '".$location."' and a.created_dttm BETWEEN '".$datestartapplication."' and '".$dateendapplication."'  ");
            ...
            <li class="active"><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-file-excel-o"></i>Report </a>
              <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                ...
                <li><a href="Time.php" onclick="openOverlay()"><i class="fa fa-clock-o"></i>Out Of Time</a></li>
			          <li class="active"><a href="Department.php" onclick="openOverlay()"><i class="fa fa-building-o"></i>Department</a></li>
    ...
    <div class="page">
      ...
      <section class="forms">
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Department wise report. . .</h1>
            <p>(Search result for specific Department)</p>
          </header>
          <div class="row">
            <div class="col-lg-4">
            </div>
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <p>(Details report for specific Department)</p>
                  <?php
                  if($role == 1)
                  {
                    ?>
            ...
            if($success == "Change")
            {
                ...
                echo '<label class="text-success">Reporting for Operator ID - '.$operator_id.' is Updated for Date - '.$dateapplication.'</label>';
						...
						if($success == "Exists")
						{
                            ...
                            //echo $output;
                            ?>
								<form style="border-style: none;" action = "genDepartment.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
                                ...
                                <div id = "range_reporting_table">
                                    ...
                                    {
                                      $sql = "SELECT a.state,a.district,a.dept,a.operator_id,b.username,a.pec_location,a.stid_db,a.stid_csv,a.updatecorrection,a.csv_upco,a.enrollment,a.csv_newen,a.original_enrollment,a.en_diff,a.remarks,date_format(a.created_dttm,'%d-%M-%Y')  from tbl_attendance a, tbl_operator b where a.operator_id = b.operator_id and a.state = '".$state."' and a.district = '".$district."' and a.dept = '".$location."' and a.created_dttm BETWEEN '".$datestartapplication."' and '".$dateendapplication."' order by a.created_dttm";
                                      $result = mysqli_query($con, $sql);
                                      while($row = mysqli_fetch_row($result)) {
                                      ?>
                                       <tbody id="myTable">
						...
						if($error == "Not Exists")
						{
							//header( "refresh:3;url=Operator.php" );
							echo '<div class="spinner-grow spinner-grow-sm"> </div><span> &nbsp;&nbsp;&nbsp;</span>';
							echo '<label class="text-danger">No Reporting result found for Department - '.$location.'</label>';
							//header( "refresh:3;url=Operator.php" );
						}
					?>
				</div>
      ...
      <script>
            $(document).ready(function(){
                $('#gen_rep').click(function(){
                    var excel_data = $('#range_reporting_table').html();
                    var page = "genDepartment.php?data="+excel_data;
                    window.location = page;
                });
            });
      </script>
