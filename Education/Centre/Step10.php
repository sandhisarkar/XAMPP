...
$cen_pin = $stat['cen_pin'];
	...
	$course_fees = $_POST['course_price'];
	...
	$created_date = date("Y-m-d");
	 ...
	 $sql="UPDATE admission_details SET course_fees='".$course_fees."',net_payment = '".$net_payment."',status='".$status."',created_dttm='".$created_date."' WHERE student_id='".$stu_id."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step10.php?stu_id=<?php echo  $stu_id?>" method="post" enctype="multipart/form-data">
											...
											<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;">
												...
												<tr>
													<td>
														...
														<input readonly required = "true" value ="<?php echo $course_price?>" type="text" id="course_price" name="course_price"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;margin-bottom: 14px;">
												...
												<tr>
													<td>
														...
														<input readonly required = "true" value ="<?php echo $net_payment?>" type="text" id="net_payment" name="net_payment"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;margin-bottom: 14px;">
