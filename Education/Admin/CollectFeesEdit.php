...
$pay_date = $_POST["pay_month_year"];

$pay_year = substr($pay_date,0,4);

$pay_month = substr($pay_date,5,2);
...
mysqli_select_db( $con,"fees_collection");
	...
	$sql="UPDATE fees_collection set course_id = '".$course_id."',discount = '".$dis."',pay_month = '".$pay_month."',pay_year = '".$pay_year."',pay_date = '".$pay_date."',pay_period = '".$get_pay_period."',modified_dttm = '".$modified_date."' where student_id = '".$get_stu_ID."' and id = '".$get_fees_id."'";
