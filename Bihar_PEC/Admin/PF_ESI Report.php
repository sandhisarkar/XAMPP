...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>Generate Monthly PF/ESI Payment Advice</u> </h2>
				...
				<div class="row">
					...
					<?php
					 if($msg == "not ok")
					 {
					  ...
					  <div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s" style="margin-top:5%;">
						  <div class="box" >
							<h6 class="title" ></i> Showing Result For :  <b> Month - Year : </b> <u>[<?php echo $_POST['month_year'];?>] </u> <i class="fa fa-calendar text-info"></i></h6>
					...
					<?php
					 if($msg == "ok")
					 {
					  ...
					  <div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s" style="margin-top:5%;">
						  <div class="box">
							<h6 class="title"></i> Showing Result For :  <b> Month - Year : </b> <u>[<?php echo $_POST['month_year'];?>] </u> <i class="fa fa-calendar text-success"></i></h6>
