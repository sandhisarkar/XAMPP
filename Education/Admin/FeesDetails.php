                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Fees Collection : </h1>
										<form action="CollectFees.php?student_id=<?php echo  $get_stu_ID?>&pay_period=<?php echo $pay_p?>" method="post">
											...
											<table>
												...
												<tr>
													<td>
														...
														<input  required = "true" min="0" max="25" type="number" id="dis" name="dis"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
