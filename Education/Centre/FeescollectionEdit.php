...
$q2=mysqli_query($con,"select discount,pay_date,pay_period from fees_collection where student_id = '".$get_stu_ID."' and pay_period = '".$get_pay_period."' ");
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;">Edit Fees Collection : </h1>
										<form action="CollectFeesEdit.php?student_id=<?php echo  $get_stu_ID?>&pay_period=<?php echo $get_pay_period?>" method="post">
