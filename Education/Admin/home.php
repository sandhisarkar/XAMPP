...
$sta=mysqli_query($con,"select s_stat from t_status where s_user='".$_SESSION['user']."'");
...
$query1=mysqli_query($con ,"select count(*) from enquiry_details");
$res1=mysqli_fetch_row($query1);
$tot1 = $res1[0];

$query2=mysqli_query($con ,"select count(*) from admission_details where status = 'Completed'");
