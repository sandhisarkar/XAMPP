...
$sql="UPDATE operator_profile SET bank_name='".$_POST['bank_name']."',branch_name = '".$_POST['branch_name']."',account_no='".$_POST['account_no']."',ifsc = '".$_POST['ifsc_code']."' WHERE sl_no='".$op_sl."' AND operator_id = '".$opid."'";
  ...
  <body>
			...
			<div class="col-sm-12" style = "margin-top:0%;">
				...
				<div class="col-sm-12" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<?php
						...
						if($msgNav == "Error")
						{
							header("refresh:1;url=Operator Bank.php" );	
						...
						if($msgNav == "Success")
						{
							header("refresh:15;url=Operator Bank.php" );	
							echo '<div class="spinner-grow spinner-grow-sm"> </div><span> &nbsp;&nbsp;&nbsp;</span>';
				...
				<ul class="pagination pagination-lg" style="display: inline flow-root list-item; padding-bottom: 1%;">
						...
						?>	
						<li class="active"><a onclick= "openOverlay()" href="Operator Bank.php?Handle=<?php echo  $op_sl ;?>" data-toggle="tooltip" title="Operator Bank Details" data-placement="bottom"><i class="fa fa-university" aria-hidden="true"></i></a></li>						
						<?php
						...
						?>
						<?php
							if($basic == null || $hra == null || $conv == null || $allow == null)
							{
								?>
				...
				<div class="col-sm-12" style = "text-align: center; margin-left: auto;margin-right: auto;">
					<center>
						<form  action = "Operator Bank.php?Handle=<?php echo  $op_sl;?>" method ="post"  id = "export_excel" enctype="multipart/form-data">
						<div class="col-sm-4">
							<div class="input-group mb-3">
								<div class="input-group-append">
									  <span class="input-group-text" style="background-color:transparent;border:0;">Bank Name :</span>
								</div>
								
								<input value ="<?php echo $bankname;?>" class="form-control" type="text" id="bank_name" name="bank_name" required="true" placeholder ="Enter Bank Name" autocomplete="off" style ="border-radius:5px;" autofocus></input>
							 </div>
						</div>
						...
						<div class="col-sm-4">
							<div class="input-group mb-3">
								<div class="input-group-append">
									  <span class="input-group-text" style="background-color:transparent;border:0;margin-left: -13px;">Branch Name :</span>
								</div>
								
								<input value ="<?php echo $branchname;?>" class="form-control" type="text" id="branch_name" name="branch_name" required="true" placeholder ="Enter Branch Name"autocomplete="off" style ="border-radius:5px;" autofocus></input>
							 </div>
						</div>
						...
						<div class="col-sm-4">
							<div class="input-group mb-3">
								<div class="input-group-append">
									  <span class="input-group-text" style="background-color:transparent;border:0;margin-left: -38px;">Account Number :</span>
								</div>
								
								<input value ="<?php echo $acc;?>" class="form-control" pattern= "^\d{9,18}$" type="text" id="account_no" name="account_no" autocomplete="off" placeholder ="Enter Account Number" required="true" style ="border-radius:5px;" autofocus></input>
							 </div>
						</div>
						...
						<div class="col-sm-4">
							<div class="input-group mb-3">
								<div class="input-group-append">
									  <span class="input-group-text" style="background-color:transparent;border:0;margin-left: 11px;">IFSC Code :</span>
								</div>
								
								<input value ="<?php echo $ifsc;?>" class="form-control" pattern = "^[A-Z]{4}[0][A-Z0-9]{6}$" type="text" id="ifsc_code" name="ifsc_code" autocomplete="off" placeholder ="Enter IFSC Code" required="true" style ="border-radius:5px;" autofocus></input>
							 </div>
						</div>
						
						<input class="toggle btn btn-primary"  onclick="uploadme()" type="submit" id="update_bank" name = "update_bank" value="Update Operator Bank" style="font-family: Verdana;  margin-top:15px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
	...
	<script>
		...
		function uploadme()
		{
			...
			var patt = new RegExp("^[0-9]{9,18}$");
			var res = patt.test(account_no);
			
			var patt1 = new RegExp("^[A-Z]{4}[0][A-Z0-9]{6}$");
			var res1 = patt1.test(ifsc_code);
			
			
			
			if(bank_name !== "" && branch_name !== ""  && account_no !== "" && ifsc_code !== "" &&  res == true && res1 == true)
			{
				document.getElementById("overlay").style.display = "block";
