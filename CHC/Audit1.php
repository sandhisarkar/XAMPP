...
if (isset($_POST["excel_sub"])){
	...
	if($runno != null && $percent != null)
	{
		...
		while($row1 = mysqli_fetch_row($result9)) {
			...
			$sql_polstat_q=mysqli_query($con,"select status from case_file_master where case_file_no ='".$policy_number."' and proj_code = '".$proj_code."' and bundle_key = '".$bundle_key."'");
							...
							if (mysqli_num_rows($result1) > 0) {
								...
								?>
									...
									while($row = mysqli_fetch_row($result1)) {
                                        ...
                                        $sql_polstat=mysqli_query($con,"select status from case_file_master where case_file_no ='".$policy_no."' and proj_code = '".$proj_code."' and bundle_key = '".$bundle_key."'");
