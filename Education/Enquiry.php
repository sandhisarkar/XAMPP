									...
									<div class="col-sm-12">
										...
										<form action="Enquiry.php" method="post">
											...
											<table>
												...
												<tr>
													<td>
														...
														<input disabled value ="<?php echo $centre_name;?>" type="text" id="centre_name" name="centre_name" required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 250px;text-transform: uppercase;"></input>
												...
												<tr>
													<td>
														...
														<input disabled value ="<?php echo $centre_location;?>" type="text" id="centre_location" name="centre_location" required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 250px;text-transform: uppercase;">
											...
											<table>
												...
												<tr>
													<td>
														<font style="color:White; margin-left:33px; font-family: Verdana;  margin-top:15px; font-size:17px;">Student Address : &nbsp;&nbsp;&nbsp;</font> 
														
															<textarea required="true" id="student_address"  name="student_address"  required="true" style="font-size: 15px;height: 50px;padding-top: 0px;margin-top: 25px;width: 250px;text-transform: uppercase;">
												...
												<tr>
													<td>
														<font style="color:White; margin-left:105px; font-family: Verdana;  margin-top:15px; font-size:17px;">Remarks : &nbsp;&nbsp;&nbsp;</font> 
														<input type="text" id="remarks" name="remarks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 250px;text-transform: uppercase;margin-bottom: 4px;">
