...
$cen_pin = $stat['cen_pin'];
	...
	$present_board = $_POST['present_board'];
	 ...
	 $sql="UPDATE admission_details SET present_school='".$present_school."',present_board = '".$present_board."',status='".$status."',created_dttm='".$created_date."' WHERE student_id='".$stu_id."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step7.php?stu_id=<?php echo  $stu_id?>" method="post">
											<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;">
												...
												<tr>
													<td>
														...
														<input required="true" type="text" id="additioanl_number" name="additioanl_number"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
