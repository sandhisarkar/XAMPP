...
$q1=mysqli_query($con,"select sum(bill_amount_per_month_per_operator) from salary_month_details where customer_bill_status = 'Completed' ");
...
if(isset($_POST["excel_sub"]))
{
	...
	/*$sql= "SELECT DISTINCT(MONTH_YEAR),sum(bill_amount_per_month_per_operator) FROM salary_month_details WHERE created_dttm >=  '".$stDt1."' AND created_dttm <= '".$ymd."' ORDER BY MONTH_YEAR DESC";
				...
				echo $nyy;
				echo $gg;*/
	$sql = "SELECT DISTINCT(MONTH_YEAR) FROM salary_month_details WHERE created_dttm >=  '".$stDt1."' AND created_dttm <= '".$ymd."' AND customer_bill_status = 'Completed' ORDER BY MONTH_YEAR ASC";
	  $result = mysqli_query($con, $sql);
	//echo $sql;
	...
	$msg = "ok";
		...
		$q1=mysqli_query($con,"select sum(bill_amount_per_month_per_operator) from salary_month_details WHERE created_dttm >=  '".$stDt1."' AND created_dttm <= '".$ymd."' AND customer_bill_status = 'Completed' ORDER BY MONTH_YEAR ASC");
		$n1=  mysqli_fetch_row($q1);
		$totamt1= $n1[0];
...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>Customer Monthly Billing Summary</u> </h2>
			...
			<div class="col-sm-12">
				...
				<div class="row">
					  ...
					  <div class="col-sm-12  wow bounceInUp" data-wow-duration="1.6s" style="margin-top: 5%;">
							...
							<form  action = "Centre Billing.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
						    <div>
					 ...
					 $result = mysqli_query($con, "SELECT DISTINCT(MONTH_YEAR) FROM salary_month_details WHERE created_dttm >=  '".$stDt1."' AND created_dttm <= '".$ymd."' AND customer_bill_status = 'Completed'  ORDER BY MONTH_YEAR ASC");
					 while($row = mysqli_fetch_row($result)) {
						 
						 $month_yr = $row[0];
						 
						  $result1 = mysqli_query($con, "SELECT sum(bill_amount_per_month_per_operator),Count(centre_name) FROM salary_month_details WHERE month_year =  '".$month_yr."' AND customer_bill_status = 'Completed' ");
					...
					<div class="col-md-6  wow bounceInUp" data-wow-duration="1.4s">
						...
						<div class="col-mb-6 wow bounceInUp displayNone" id = "tableBill<?php echo $count;?>" data-wow-duration="1.6s" style="display:none;">
							...
							$query1 = "SELECT COUNT(centre_name),SUM(bill_amount_per_month_per_operator) FROM salary_month_details WHERE month_year =  '".$month_yr."' AND dist_name = '".$dis_distname."' AND customer_bill_status = 'Completed' ";
