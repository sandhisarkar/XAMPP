...
$msgNav = "";
	...
	$modified_date = date("Y-m-d");
	 ...
	 $sql="UPDATE admission_details SET course_fees='".$course_fees."',net_payment = '".$net_payment."',status = '".$status."',modified_dttm='".$modified_date."' WHERE student_id='".$get_stu_ID."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step10.php?student_id=<?php echo  $get_stu_ID?>" method="post" enctype="multipart/form-data">
