...
$get_stu_ID = $_GET["student_id"];
	...
	$q1=mysqli_query($con,"select present_add,permanent_add from admission_details where student_id='".$get_stu_ID."'");
	$n1=  mysqli_fetch_assoc($q1);
	 
	$present_address = $n1['present_add']; 
	$permanent_address = $n1['permanent_add']; 
	...
	$sql="UPDATE admission_details SET student_name = '".$student_name."',student_dob = '".$student_dob."',student_gender= '".$gender."',status = '".$status."',modified_dttm='".$modified_date."' WHERE student_id='".$get_stu_ID."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step3Edit.php?student_id=<?php echo  $get_stu_ID?>" method="post">
										<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 0px;">
												...
												<tr>
													<td>
														...
														<input value ="<?php echo $present_address?>" type="text" id="present_address" name="present_address"  required="true" style="font-size: 15px;height: 50px;padding-top: 0px;margin-top: 0px;width: 250px;">
												...
												<tr>
													<td>
														...
														<input value = "<?php echo $permanent_address?>" type="text" id="permanent_address" name="permanent_address"  required="true" style="font-size: 15px;height: 50px;padding-top: 0px;margin-top: 10px;width: 250px;">
