...
$cen_pin = $stat['cen_pin'];
	...
	$gur_phone = $_POST['gur_phone'];
	 ...
	 $sql="UPDATE admission_details SET student_phone='".$student_phone."',student_email = '".$student_email."',gur_phone='".$gur_phone."',status='".$status."',created_dttm='".$created_date."' WHERE student_id='".$stu_id."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step5.php?stu_id=<?php echo  $stu_id?>" method="post">
										...
										<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;">
												...
												<tr>
													<td>
														...
														<input required = "true" type="text" id="past_board" name="past_board"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
												...
												<tr>
													<td>
														...
														<input required = "true" maxlength="3" min="0" max="100" type="number" id="eng_marks" name="eng_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 100px;">
												...
												<tr>
													<td>
														...
														<input required = "true" maxlength="3" min="0" max="100" type="number" id="ls_marks" name="ls_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 100px;">
												...
												<tr>
													<td>
														...
														<input required = "true" maxlength="3" min="0" max="100" type="number" id="ps_marks" name="ps_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 100px;">
												...
												<tr>
													<td>
														...
														<input required = "true" maxlength="3" min="0" max="100" type="number" id="math_marks" name="math_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 100px;">
												...
												<tr>
													<td>
														...
														<input required = "true" type="number" min="0" max="100" step="any" id="agg" name="agg"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 100px;"><span style = "color:white;padding-left: 10px;">Percentage(%)</span>
