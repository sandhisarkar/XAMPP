...
if(isset($_REQUEST["u_sub"]))
{
 ...
 if($usr!=''&&$pwd!='')
 {
   $query=mysqli_query($con ,"select * from centre_details where cen_id='".$usr."' and user_password='".$pwd."'");
   $res=mysqli_fetch_row($query);
   $query1=mysqli_query($con ,"select * from centre_details where cen_id='".$usr."'");
                            ...
                            <div id="dmain"  > 
                               ...
                               <br>
								<h4 style="color:red; margin-left: 75px;"> 
                                    ...
                                    <input type="text" id="u_user" name="u_user" class="form-control" style="width:320px; margin-left: 60px; "  placeholder="Enter Your Centre ID" style = "text-transform: uppercase;"><br>
