...
$pay_year = substr($get_pay_period,3,4);

$pay_month = substr($get_pay_period,0,2);

$pay_date = $pay_year.'-'.$pay_month.'-'.'01';

$get_pay_period1 = $pay_month."-".$pay_year;
...
mysqli_select_db( $con,"fees_collection");
	...
	$sql="UPDATE fees_collection set course_id = '".$course_id."',discount = '".$dis."',pay_month = '".$pay_month."',pay_year = '".$pay_year."',pay_date = '".$pay_date."',pay_period = '".$get_pay_period."',modified_dttm = '".$modified_date."' where student_id = '".$get_stu_ID."' and pay_period = '".$get_pay_period."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Fees Collection : </h1>
										<form action="FinalPayEdit.php?student_id=<?php echo  $get_stu_ID?>&discount=<?php echo $dis?>&id=<?php echo $get_fees_id ?>&pay_period=<?php echo $get_pay_period ?>" method="post">
