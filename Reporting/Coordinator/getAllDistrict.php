...
if($district == "All")
{
  $query ="SELECT DISTINCT(TRIM(district)) FROM tbl_attendance WHERE state = '" . $_POST["state"]."' and district != '' order by district asc";
...
else
{
  ...
  $query ="SELECT DISTINCT(TRIM(district)) FROM tbl_attendance WHERE state = '" . $_POST["state"]."' and district != '' and district = '".$district."' order by district asc";
