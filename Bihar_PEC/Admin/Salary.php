				...
				<div class="row">
					...
					<?php
					 if($msg == "not ok")
					 {
					  ...
					  <div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s" style="margin-top:5%;">
						  <div class="box" >
							<h6 class="title"><i class="fa fa-search text-info"></i> No Operator's Salary Payment Record Found For :  <u>[<?php echo $_POST['start_date'];?>] </u> - <u> [<?php echo $_POST['end_date'];?>]</u>  <i class="fa fa-calendar text-info"></i></h6>
					...
					<?php
					 if($msg == "ok")
					 {
					  ...
					  <div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s" style="margin-top:5%;">
						  <div class="box" >
							<h6 class="title"><i class="fa fa-search text-info"></i> Operator's Salary Payment Advice Record Generated For : <u>[<?php echo $_POST['start_date'];?>] </u> - <u> [<?php echo $_POST['end_date'];?>]</u> <i class="fa fa-calendar text-info"></i></h6> 
