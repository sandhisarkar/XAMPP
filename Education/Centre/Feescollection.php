																	...
																	if($date_fetch <= $date_now && $date_now <= $res1["ad_end_date"])
																	{
																			...
																			for($j =0 ;$j<= $totm ; $j++)
																			{
																				...
																				if($cou2 == 0)
																				{
																					...
																					<td style = "padding: 0px;"><?php echo  $res1["student_id"]?></td>
																					<td style = "padding: 0px;"><?php echo  $res1["student_name"]?></td>
																					
																					<td style = "padding: 0px;"><?php echo  $res1["student_class"]?></td>
																					<td style = "padding: 0px;"><?php echo  $res1["student_course"]?></td>
																					<td style = "padding: 0px;"><?php echo  $res1["course_fees"]?></td>
																					<td style = "padding: 0px;"><?php echo  $fees_paid_date?></td>
																					<td style = "padding: 0px;"><?php echo  'Deu'?></td>
																					<td style = "padding: 0px;width: 120px;"><a href="FeesDetails.php?student_id=<?php echo  $res1["student_id"]?>&pay_period=<?php echo $fees_paid_date?>">Pay <i class="fas fa-credit-card" style="font-size:25px"></i></a></td>
																					</tr>
																					<?php
																				}
																				else{
