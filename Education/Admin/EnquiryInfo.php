									...
									<div class="col-sm-12">
											...
											<table style="width:100%; font-size: larger;">
												...
												<?php
															...
															$sql = "SELECT centre_name,centre_location,enq_id,student_name,student_phone,admission_class,student_course,source,remarks,status FROM enquiry_details order by enq_id";
															...
															if (mysqli_num_rows($result) > 0) {
																...
																while($row = mysqli_fetch_assoc($result)) {
																	...
																	<td style = "padding: 0px;"><?php echo  $row["enq_id"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["centre_name"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["centre_location"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["student_name"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["student_phone"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["admission_class"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["student_course"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["source"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["remarks"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["status"]?></td>
																	<td style = "padding: 0px;"><a href="EnquiryEdit.php?enq_id=<?php echo  $row["enq_id"]?>"><i class="fas fa-edit" style="font-size:25px"></i></a></td>	
																	</tr>
