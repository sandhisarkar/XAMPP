...
if(isset($_POST["sub_excel"]))
{
	...
	$sql="UPDATE salary_month_details SET vendor_bill_status = 'Completed' WHERE month_year='".$month_yr."'";
...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>Vendor Billing Invoice Approval</u> (Monthly)</h2>
			...
			<div class="col-sm-12" style = "margin-top:5%;">
				...
				<div class="col-sm-6" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<center>
						...
						<form  action = "Vendor Bill Approval.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
							<table>
								...
								<td style = "text-align: center;margin-left: auto;margin-right: auto;">
									...
									<select required="true" id="month_year" name="month_year" onchange="Check()" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 300px;">
										...
										<?php
											...
											$sql = "SELECT DISTINCT(month_year) FROM salary_month_details where vendor_bill_status  = 'Pending'";
				...
				<div class="row" style="margin-top: 5%;">
					<?php
						...
						if($msgNav == "Success")
						{
							...
							<div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6>Vendor Bill Invoice Approved Successfully . . .  <i class="fa fa-check text-success"></i></h6>
