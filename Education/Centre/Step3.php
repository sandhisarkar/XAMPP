...
$cen_location = $stat["cen_location"];
	...
	$permanent_add = strtoupper($_POST['permanent_address']);
	 ...
	 $sql="UPDATE admission_details SET present_add='".$present_add."',permanent_add = '".$permanent_add."',status='".$status."',created_dttm='".$created_date."' WHERE student_id='".$stu_id."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step4.php?stu_id=<?php echo  $stu_id?>" method="post">
										...
										<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 100px;">
												...
												<tr>
													<td>
														...
														<input required ="true" type="text" id="student_phone" name="student_phone"  pattern="[0-9]{10}" maxlength="10" required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;"><span style = "color:white;padding-left: 275px;">[Format: 9999999999]</span>
												...
												<tr>
													<td>
														...
														<input  type="email" id="student_email" name="student_email"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
												...
												<tr>
													<td>
														...
														<input required ="true" type="text" id="gur_phone"  pattern="[0-9]{10}" maxlength="10" name="gur_phone"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;"><span style = "color:white;padding-left: 275px;">[Format: 9999999999]</span>
