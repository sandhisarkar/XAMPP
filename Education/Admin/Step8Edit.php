...
$msgNav = "";
	...
	$q_id=mysqli_query($con,"select student_course,student_class,discount,ad_start_date,ad_end_date from admission_details where student_id='".$_GET["student_id"]."'");
	$n_id=  mysqli_fetch_assoc($q_id);
	
	$student_course = $n_id['student_course']; 
	$student_class = $n_id['student_class']; 
	$discount = $n_id['discount']; 
	$ad_start_date = $n_id['ad_start_date'];
	$ad_end_date = $n_id['ad_end_date']; 
	...
	$picpath="Admin/documents/photo/".$get_stu_ID."/";
	if(!is_dir($picpath))
	{
	...
	$markpath ="Admin/documents/marksheet/".$get_stu_ID."/";
	if(!is_dir($markpath))
	{
	...
	$docpath="Admin/documents/admission_proof/".$get_stu_ID."/";
	...
	$proofpath="Admin/documents/id_proof/".$get_stu_ID."/";
	if(!is_dir($proofpath))
	{
	  ...
	  )
	{
	 ...
	 $sql="UPDATE admission_details SET photo_upload='".$picpath."',marksheet_upload = '".$markpath."',admission_document_upload='".$docpath."',id_proof_upload='".$proofpath."',status ='".$status."',modified_dttm='".$modified_date."' WHERE student_id='".$get_stu_ID."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step9Edit.php?student_id=<?php echo  $get_stu_ID?>" method="post" enctype="multipart/form-data">
											...
											<div class="col-sm-8" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;">
													...
													<td>
														...
														<select required="true" id="class_for" name="class_for" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 250px;">
																...
																<?php
																	...
																	$sql = "SELECT class_name FROM class_master where class_name <> '".$student_class."'";
																	$result = mysqli_query($con, $sql);
																	if (mysqli_num_rows($result) > 0) {
																	// output data of each row
																	while($row = mysqli_fetch_assoc($result)) {
												...
												<tr>
													<td>
														...
														<input value="<?php echo $ad_start_date?>"required="true" type="date" id="ad_start_date" name="ad_start_date"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 40px;width: 150px;text-transform: uppercase;">
														<font style="color:White; margin-left: 45px; font-family: Verdana;  margin-top:15px; font-size:17px;">End Date : &nbsp;</font> 
														<input value="<?php echo $ad_end_date?>" required="true" type="date" id="ad_end_date" name="ad_end_date"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 40px;width: 150px;text-transform: uppercase;">
													</td>
												</tr>
												...
												<tr>
													<td>
														...
														<input value="<?php echo $discount?>" required = "true" min="0" max="25" type="number" id="dis" name="dis"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;margin-bottom: 14px;">
