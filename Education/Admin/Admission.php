												...
												<?php
															...
															if (mysqli_num_rows($result) > 0) {
																...
																while($row = mysqli_fetch_assoc($result)) {
																	...
																	<td style = "padding: 5px;"><a href="Step1.php?cen_name=<?php echo  $row["cen_name"]?>&cen_location=<?php echo  $row["cen_location"]?>">Contact Us<i class="fas fa-address-book" style="font-size:25px"></i></a></td>
