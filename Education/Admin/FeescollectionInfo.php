...
if(($get_stu_ID == NULL)OR($get_fees_ID == NULL))
{
	$msgNav = "";
}
...
{
   $sql="Delete from fees_collection where student_id = '".$get_stu_ID."' and id = '".$get_fees_ID."'";
												...
												<?php
															...
															if (mysqli_num_rows($result) > 0) {
																...
																while($row = mysqli_fetch_assoc($result)) {
																	...
																	<td style = "padding: 0px;"><?php echo  $row["id"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["pay_period"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["student_id"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["course_id"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["course_fees"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["discount"]?></td>
																	<td style = "padding: 0px;"><?php echo  $row["total_pay_amount"]?></td>
																	
																	<td style = "padding: 0px;"><a href="FeescollectionEdit.php?student_id=<?php echo  $row["student_id"]?>&fees_id=<?php echo $row["id"]?>"><i class="fas fa-edit" style="font-size:25px"></i></a></td>
																	<td style = "padding: 0px;"><a href="FeescollectionInfo.php?student_id=<?php echo  $row["student_id"]?>&fees_id=<?php echo $row["id"]?>"><i class='fas fa-trash-alt' style='font-size:25px'></a></i></td>
																	</tr>
