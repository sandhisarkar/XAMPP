...
$q1=mysqli_query($con,"select student_name,student_dob,student_gender from admission_details where student_id = '".$get_stu_ID."'");
$n1=  mysqli_fetch_assoc($q1);

$student_name = $n1['student_name'];
$student_dob = $n1['student_dob'];
$student_gender = $n1['student_gender'];
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step2Edit.php?student_id=<?php echo  $get_stu_ID?>" method="post">
											...
											<table>
												...
												<tr>
													<td>
														...
														<input value = "<?php echo $student_dob ?>" required="true" type="date" id="student_dob" name="student_dob"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;text-transform: uppercase;">
												...
												<tr>
													<td>
														...
														<?php  
															...
															{
																?>
																<input required="true" checked type="radio" id="student_gender" name="student_gender" value="Male" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;"> &nbsp; Male &nbsp;</span>
																<?php
															}else
															{
																?>
																<input required="true" type="radio" id="student_gender" name="student_gender" value="Male" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;"> &nbsp; Male &nbsp;</span>
																<?php
															}
														?>
														<?php  
															...
															{
																?>
																<input checked type="radio" id="student_gender" name="student_gender" value="Female" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;">&nbsp; Female &nbsp;</span>
																<?php
															}else
															{
																?>
														...
														<?php  
															if($student_gender == "Other")
															{
																?>
																<input checked type="radio" id="student_gender" name="student_gender" value="Other" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;">&nbsp; Other &nbsp;</span>
																<?php
															}else
															{
																?>
