...
$cen_name = $_GET["cen_name"];
	...
	$cen_pin = $n1['cen_pin'];
	 ...
	 $query=mysqli_query($con ,"select MAX(id) from admission_details where centre_id = '".$cen_id."'");
	...
	$sql="INSERT INTO admission_details (id,centre_id,centre_name,centre_location,student_id,student_name,student_dob,student_gender,status,created_dttm) VALUES ('".$genStuID."','".$cen_id."','".$cen_name."','".$cen_location."','".$stu_id."','".$student_name."','".$student_dob."','".$gender."','".$status."','".$created_date."')";
