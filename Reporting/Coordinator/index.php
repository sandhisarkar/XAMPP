...
<html>
  ...
  <body>
    ...
    <div class="page">
      ...
      if($role == 1)
      {
        $sql_state = "SELECT distinct(state) from tbl_operator where state = '".$state."' order by state asc";
                        ...
                        <div id="updates-boxzzz_<?php echo $statename;?>" >
                          <form style="border-style: none;" action = "genActiveOperator.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
                            <div class="form-group">
                              ...
                              <input type="hidden"  id="txtSequenceId5" name="txtSequenceId5" value="<?php echo $district; ?>"/>
                            </div>
                            <div class="form-group">
      ...
      {
        $sql_state = "SELECT distinct(state) from tbl_operator where state = '".$state."' and district = '".$district."' order by state asc";
        $result_state = mysqli_query($con, $sql_state);
                      ...
                      <div class="wrapper count-title d-flex">
                        ...
                        <div class="name"><strong class="text-uppercase">Total Working Operators</strong><span></span>
                          ...
                          <?php 
                              ...
                              $query3=mysqli_query($con ,"SELECT Count(*) from tbl_operator where emp_status = 1 and state = '".$statename."' and district = '".$district."' ");
                              $res3=mysqli_fetch_row($query3);
                              $totexists = $res3[0];

                              $query4=mysqli_query($con ,"SELECT Count(*) from tbl_operator where emp_status = 2 and state = '".$statename."' and district = '".$district."' ");
                              $res4=mysqli_fetch_row($query4);
                              $totnew = $res4[0];
                              echo $totexists + $totnew;
                            ?>
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <hr>
                                        ...
                                        <table class="table table-hover table-bordered table-striped" border ='1' width='100%' style = "text-align: center; overflow-x:auto;font-size: small;">
                                          ...
                                          $sql_summary_count = "SELECT Distinct `district` FROM `tbl_attendance` WHERE `state` = '".$statename."' and district = '".$district."' ";
                                          $result_dis = mysqli_query($con, $sql_summary_count);
                                          $dailyensum = 0;
                                          $dailyupsum = 0;
                                          while ($rowdis = mysqli_fetch_row($result_dis))
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <hr>
                                        ...
                                        <table class="table table-hover table-bordered table-striped" border ='1' width='100%' style = "text-align: center; overflow-x:auto;font-size: small;">
                                          ...
                                          <?php
                                          $datetoday = date("Y-m-d");
                                          $sql_summary_count = "SELECT Distinct `district` FROM `tbl_operator` WHERE `state` = '".$statename."' and district = '".$district."' ";
                                          $result_dis = mysqli_query($con, $sql_summary_count);
                                          $dailyensum = 0;
                                          $dailyupsum = 0;
                                          while ($rowdis = mysqli_fetch_row($result_dis))
                      ...
                      <!--div id="new-updates" class="card updates recent-updated"-->
                        ...
                        <div id="updates-boxzzz_<?php echo $statename;?>" >
                          <form style="border-style: none;" action = "genActiveOperator.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
                            ...
                            $sql = "select sl_no,state,dept,district,Operator_id,username,pec_location,station_id,emp_status from tbl_operator where state = '".$statename."' and district = '".$district."' ORDER BY sl_no";
                            $result = mysqli_query($con, $sql);
                            $cenID = "";
                            if (mysqli_num_rows($result) > 0) {
                              ?>
