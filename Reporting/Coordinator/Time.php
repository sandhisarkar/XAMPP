    ...
    //{
        ...
        //{
			...
			if($district == "All")
			{
				...
				$result=mysqli_query($con ,"SELECT distinct(c.operator_id) from tbl_outrangetime a, tbl_operator b, tbl_attendance c where a.operator_id = b.operator_id and b.operator_id = c.operator_id and c.state = '".$state."' and a.created_date BETWEEN '".$datestartapplication."' and '".$dateendapplication."' ");
			...
			{
				$created_dttm = $year."-".$month."-".$day;
				$result=mysqli_query($con ,"SELECT distinct(c.operator_id) from tbl_outrangetime a, tbl_operator b, tbl_attendance c where a.operator_id = b.operator_id and b.operator_id = c.operator_id and c.state = '".$state."' and c.district = '".$district."' and  a.created_date BETWEEN '".$datestartapplication."' and '".$dateendapplication."' ");
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-file-excel-o"></i>Report </a>
              <ul id="exampledropdownDropdown1" class="collapse list-unstyled ">
                ...
                <li class="active"><a href="Time.php" onclick="openOverlay()"><i class="fa fa-clock-o"></i>Out Of Time</a></li>
      ...
      <div class="breadcrumb-holder">
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Time Range</li>
          </ul>
        </div>
      </div>
      <section class="forms">
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Out of time range wise report. . .</h1>
            <p>(Search result with specific out of time range)</p>
          </header>
          <div class="row">
            <div class="col-lg-4">
            </div>
            ...
            <div class="col-lg-4">
              <div class="card">
                ...
                <div class="card-body">
                  <p>(Details report for specific out of time range)</p>
                  <?php
                  if($role == 1)
                  {
                    ?>
            ...
            <div class="col-sm-12" style = "text-align: center; margin-left: auto;margin-right: auto;">
					<?php
						...
						if($success == "Exists")
						{
                            ...
                            //echo $output;
                            ?>
								<form style="border-style: none;" action = "genTime.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
                                ...
                                <div id = "range_reporting_table">
                                    ...
                                    <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th style = 'padding:auto;'>Out of Time Reporting</th>
                                            </tr>
                                    </thead>
                                    <?php
                                  if($district == "All")
                                    ...
                                    ?>
                                     <tbody id="myTable">
                                        <tr>
                                            ...
                                            <td style = "padding: auto;"><?php echo  $row1[1]?></td>
											                      <td style = "padding: auto;"><?php echo  $row1[2]?></td>
                                            <td style = "padding: auto;"><?php echo  $row[0]?></td>
                                            <td style = "padding: auto;"><?php echo  $row1[3] ?></td>
                                            <td style = "padding: auto;"><?php echo  $row1[4]?></td>
                                            <td style = "padding: auto;"><?php echo  $row1[5]?></td>
                                            <td style = "padding: auto;"><?php echo  $row1[6]?></td>
                                            <td style = "padding: auto;"><?php echo  date('d-M-Y',strtotime($row[1])) ?></td>
                                            <?php
                                            ...
                                            ?>
                                            <td style = "padding: auto;color:red;">
