...
$msgNav = "";
	...
	$q1=mysqli_query($con,"select present_school,present_board from admission_details where student_id='".$get_stu_ID."'");
	$n1=  mysqli_fetch_assoc($q1);
	 
	$present_school = $n1['present_school']; 
	$present_board = $n1['present_board']; 
	...
	$past_board = $_POST['past_board'];
	$eng_marks = $_POST['eng_marks'];
	$ls_marks = $_POST['ls_marks'];
	$ps_marks = $_POST['ps_marks'];
	$math_marks = $_POST['math_marks'];
	$past_edu_agg = $_POST['agg'];
	
	$status = "Past Educational Info";
	
	 mysqli_select_db( $con,"admission_details");
	
	 $sql="UPDATE admission_details SET past_board='".$past_board."',eng_marks = '".$eng_marks."',ls_marks='".$ls_marks."',ps_marks = '".$ps_marks."',math_marks='".$math_marks."',past_edu_agg='".$past_edu_agg."',status = '".$status."',modified_dttm='".$modified_date."' WHERE student_id='".$get_stu_ID."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step6Edit.php?student_id=<?php echo  $get_stu_ID?>" method="post">
												<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;margin-top: 15px;">
												<table>
												<tr>
												...
												<tr>
													<td>
														<font style="color:White; margin-left:25px; font-family: Verdana;  margin-top:15px; font-size:17px;">Present School Name : &nbsp;</font> 
														<input value ="<?php echo $present_school?>" required = "true" type="text" id="present_school" name="present_school"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
														
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:33px; font-family: Verdana;  margin-top:15px; font-size:17px;">Present Board Name : &nbsp;</font> 
														<input value = "<?php echo $present_board?>" required = "true" type="text" id="present_board" name="present_board"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;margin-bottom: 14px;">
