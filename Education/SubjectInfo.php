...
{
	$sql="Delete from subject_details where subject_id = '".$get_subject_ID."'";

	if (!mysqli_query($con,$sql))
	{
	  //die('Error: ' . mysqli_error());
	  $msgNav = "Error in deleting the subject";
    }
	else
	{
	  //echo "1 record added";
	  $msgNav = "Subject is deleted successfully";
	}
}
					...
					<div class="container-fluid">
                            <div class="row" style = "width: 100%;">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -3%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Subject Details : </h1>
									...
									<div class="col-sm-12">
											...
											<table style="width:110%; font-size: larger;">
												<tr style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;font-size: x-large;">
													...
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Subject ID</th> 
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Subject Name</th>
																									
												</tr>
												<?php
															mysqli_select_db( $con,"subject_details");

															$sql = "SELECT course_id,subject_id,subject_name FROM subject_details";
															...
															if (mysqli_num_rows($result) > 0) {
																...
																while($row = mysqli_fetch_assoc($result)) {
																	...
																	<td style = "padding: 5px;"><?php echo  $row["course_id"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["subject_id"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["subject_name"]?></td>
																	
																	<td style = "padding: 5px;"><a href="SubjectEdit.php?subject_id=<?php echo  $row["subject_id"]?>"><i class="fas fa-edit" style="font-size:25px"></i></a></td>
																	<td style = "padding: 5px;"><a href="SubjectInfo.php?subject_id=<?php echo  $row["subject_id"]?>"><i class='fas fa-trash-alt' style='font-size:25px'></a></i></td>
																	<tr>
