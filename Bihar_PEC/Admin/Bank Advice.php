...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>Monthly Operators Payment Disbursement Report</u> </h2>
					 ...
					 if($msg == "not ok")
					 {
					  ...
					  <div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s" style="margin-top:5%;">
						  <div class="box">
							...
							<h6 class = "title"> Date From  :  <u>[<?php echo $_POST['start_date'];?>] </u> To <u> [<?php echo $_POST['end_date'];?>]</u> <i class="fa fa-calendar text-info"></i></h6>
						  </div>
					  </div>
					 <?php
					 }
