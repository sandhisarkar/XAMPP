...
$sqlProjcode = "select proj_code from project_master where proj_key = '".$Proj."'";
$resultProj = mysqli_query($con, $sqlProjcode);
$nProj = mysqli_fetch_row($resultProj);
$Proj_code_final = $nProj[0];
...
<link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800,900" rel="stylesheet">
		...
		<!--script src="https://cdn.rawgit.com/seikichi/tiff.js/master/tiff.min.js"></script-->
		<script src="tiff.js-master/tiff.js"></script>
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <div class="footer">
	        	<p>
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <br>All rights reserved <br><i class="fa fa-code" style="color:black;"></i> Developed by <br><a onclick= "openOverlay()" href="mailto:sandhisarkar2@gmail.com?Subject =Contact from CHC" target="_blank" style= "color: beige;">Sandhi Sarkar</a>
				</p>
	  ...
	  <div id="overlay">	  
		...
		<div class="displayNone"> 
			...
			<input type="hidden"  id="txtSequenceId10" name="txtSequenceId10" value="<?php echo $Proj_code_final;?>"/>
	...
	<script>
			function getName(val)
			{
			 ...
			 //alert(divs.length);
                   ...
                   var projcode = $('#txtSequenceId10').val();
				   var img = val;
	
				   var xhr = new XMLHttpRequest();
				   xhr.responseType = 'arraybuffer';
				   xhr.open('GET', 'Documents/'+projcode+'/'+lot+'/'+policy+'/QC/'+img+'');
