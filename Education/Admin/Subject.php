...
if(isset($_REQUEST["centre_sub"]))
{
	$course_name = $_POST['course_name'];
	 ...
	 $n_fetch=  mysqli_fetch_assoc($resultcombo);
	...
	mysqli_select_db( $con,"subject_details");
	 ...
	 $query=mysqli_query($con ,"select MAX(id) from subject_details ");
	 ...
	 $subject_id_temp2 = str_pad($gensubID,4,"0",STR_PAD_LEFT);
	 $subject_id = $subject_id_temp1."/".$subject_id_temp2;
	 
	 
	 
	 
	 $sql="INSERT INTO subject_details (id,course_id,subject_id,subject_name) VALUES ('".$gensubID."','".$course_id."','".$subject_id."','".$subject_name."')";

		if (!mysqli_query($con,$sql))
		{
		  //die('Error: ' . mysqli_error());
		  $msgNav = "Error Creating new Subject";
		   header('location:Error.php');
		}
		else
		{
		  //echo "1 record added";
		  $msgNav = "New Subject Created";
					...
					<div class="container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: 10%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Add New Subject : </h1>
									
									<div class="col-sm-6">
										<form action="Subject.php" method="post" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px;">
											<table>
												...
												<tr>
													<td>
														...
														<input type="text" id="subject_name" name="subject_name"  required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 250px;text-transform: uppercase;">
