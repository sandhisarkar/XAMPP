...
{
   $sql="Delete from admission_details where student_id = '".$get_stu_ID."'";
	...
	else
	{
	  ...
	  chdir("..");
		...
		rmdir("Admin/documents/photo/".$get_stu_ID);
		...
		rmdir("Admin/documents/marksheet/".$get_stu_ID);
		...
		rmdir("Admin/documents/admission_proof/".$get_stu_ID);
		...
		rmdir("Admin/documents/id_proof/".$get_stu_ID);
					...
					<div class="container-fluid">
                            <div class="row" style = "width: 100%;">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: 0%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission Details : </h1>
									...
									<div class="col-sm-12">
											...
											<table style="width:100%; font-size: larger;">
												<tr style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;font-size: 13px;">
													...
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">D.O.B</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Gender</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Contact</th>
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Guardian Contact</th>
												...
												<?php
															...
															$sql = "SELECT * FROM admission_details where centre_id = '".$stcen_id."'";
															...
															if (mysqli_num_rows($result) > 0) {
																...
																while($row = mysqli_fetch_assoc($result)) {
																	?>
																	<tr style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white; font-size: 11px;">
																	<td style = "padding: 3px;"><?php echo  $row["student_id"]?></td>
																	<td style = "padding: 3px;"><?php echo  $row["student_name"]?></td>
																	<td style = "padding: 3px;"><?php echo  $row["student_dob"]?></td>
																	<td style = "padding: 3px;"><?php echo  $row["student_gender"]?></td>
																	<td style = "padding: 3px;"><?php echo  $row["student_phone"]?></td>
																	<td style = "padding: 3px;"><?php echo  $row["gur_phone"]?></td>
																	<td style = "padding: 3px;"><?php echo  $row["student_class"]?></td>
																	...
																	<td style = "padding: 3px;"><a href="Step1Edit.php?student_id=<?php echo  $row["student_id"]?>"><i class="fas fa-edit" style="font-size:21px"></i></a></td>
																	<td style = "padding: 3px;"><a href="AdmissionInfo.php?student_id=<?php echo  $row["student_id"]?>"><i class='fas fa-trash-alt' style='font-size:21px'></a></i></td>
																	</tr>
