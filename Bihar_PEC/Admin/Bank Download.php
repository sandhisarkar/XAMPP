...
if(isset($_POST["sub_excel"]))
{
	...
	$q1=mysqli_query($con,"select DISTINCT bank_advice_doc from salary_month_details where month_year = '".$month_yr."' AND bank_advice_status = 'Completed'");
	$n1=  mysqli_fetch_row($q1);
	//echo $query;
	$bank_doc= $n1[0];
	
	//echo strlen($pf_doc);
	$bank_doc = substr($bank_doc,6,strlen($bank_doc)-6);
...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>Download Bank Payment Document</u> (Monthly)</h2>
			...
			<div class="col-sm-12" style = "margin-top:5%;">
				...
				<div class="col-sm-6" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<center>
						...
						<form  action = "Bank Download.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
							<table>
								...
								<td style = "text-align: center;margin-left: auto;margin-right: auto;">
									...
									<select required="true" id="month_year" name="month_year" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 300px;">
										...
										<?php
											...
											$sql = "SELECT DISTINCT(month_year) FROM salary_month_details where bank_advice_status  = 'Completed' order by month_year ASC";
				...
				<div class="row" style="margin-top: 5%;">
					<?php
						...
						if($msgNav == "Success")
						{
							...
							<div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-search text-info"></i> Showing Bank Payment Advice . . .  </i></h6>
						  ...
						  <div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-file text-warning"></i> Download Bank Payment Advice . . .  </i></h6>
								<button class="btn btn-primary" style="background: green;"> <a href="<?php echo $bank_doc;?>" style ="color: white;" download="Bank_Advice_<?php echo $month_yr;?>.pdf">Download <i class="fa fa-download" style ="color: white;"></i></a></button>
							  </div>
						  </div>
