...
if(isset($_POST["gen_rep"]))
{
	...
	if($district == "All")
	{
		$rep_query = "SELECT distinct(a.operator_id) from tbl_attendance a, tbl_operator b where a.operator_id = b.operator_id and a.state = '".$state."' and  a.operator_id = '".$operator."' and a.created_dttm BETWEEN '".$datestartapplication."' and '".$dateendapplication."'";
	...
	{
		$rep_query = "SELECT distinct(a.operator_id) from tbl_attendance a, tbl_operator b where a.operator_id = b.operator_id and a.state = '".$state."' and a.district = '".$district."' and  a.operator_id = '".$operator."' and a.created_dttm BETWEEN '".$datestartapplication."' and '".$dateendapplication."'";
		$result=mysqli_query($con ,$rep_query);
