...
if(isset($_POST["sub_excel"]))
{
	...
	$q1=mysqli_query($con,"select DISTINCT customer_bill_doc from salary_month_details where month_year = '".$month_yr."' AND customer_bill_status = 'Completed'");
...
<html lang="en">
  ...
  <script>
      ...
      <div id="content" class="p-4 p-md-5 pt-5" >
        ...
        <h2 class="mb-4"><u>Download Customer Invoice</u> (Monthly)</h2>
			...
			<div class="col-sm-12" style = "margin-top:5%;">
				...
				<div class="col-sm-6" style = "text-align: center; margin-left: auto;margin-right: auto;">
					...
					<center>
						...
						<form  action = "Customer Bill Download.php" method ="post"  id = "export_excel" enctype="multipart/form-data">
							<table>
								...
								<td style = "text-align: center;margin-left: auto;margin-right: auto;">
									...
									<select required="true" id="month_year" name="month_year" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 25px;width: 300px;">
										...
										<?php
											...
											$sql = "SELECT DISTINCT(month_year) FROM salary_month_details where customer_bill_status  = 'Completed'";
				...
				<div class="row" style="margin-top: 5%;">
					<?php
						...
						if($msgNav == "Success")
						{
							...
							<div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-search text-info"></i> Showing Customer Bill Advice . . .  </i></h6>
						  ...
						  <div class="col-md-12  wow bounceInUp" data-wow-duration="2.4s">
							  <div class="box" >
								<h6><i class="fa fa-file text-warning"></i> Download Customer Bill Advice . . .  </i></h6>
								<button class="btn btn-primary" style="background: green;"> <a href="<?php echo $cus_bill_doc;?>" style ="color: white;" download="Customer_Bill_Advice_<?php echo $month_yr;?>.pdf">Download <i class="fa fa-download" style ="color: white;"></i></a></button>
							  </div>
						  </div>
