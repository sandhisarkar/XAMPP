...
$cen_per = $stat["user_name"];
	...
	$q_id=mysqli_query($con,"select photo_upload,marksheet_upload,admission_document_upload,id_proof_upload from admission_details where student_id='".$_GET["student_id"]."'");
	$n_id=  mysqli_fetch_assoc($q_id);
	
	$photo_upload = $n_id['photo_upload']; 
	$marksheet_upload = $n_id['marksheet_upload']; 
	$admission_document_upload = $n_id['admission_document_upload']; 
	$id_proof_upload = $n_id['id_proof_upload']; 
	
	$modified_date = date("Y-m-d");
	
	$id_proof = $_POST['id_proof'];
	$additioanl_number = strtoupper($_POST['additioanl_number']);
	
	$status = "Additional Info";
	
	 mysqli_select_db( $con,"admission_details");
	
	 $sql="UPDATE admission_details SET id_proof='".$id_proof."',additioanl_number = '".$additioanl_number."',status = '".$status."',modified_dttm='".$modified_date."' WHERE student_id='".$get_stu_ID."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step8Edit.php?student_id=<?php echo  $get_stu_ID?>" method="post" enctype="multipart/form-data">
											
											<div class="col-sm-8" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;">
												<table>
												<tr>
													<td><p style = "color:white;margin-top: 5px;"><u>Document Upload</u></p></td>
												</tr>
												...
												<tr>
													<td>
														<font style="color:White; margin-left:285px; font-family: Verdana; font-size:17px;">Photo Proof:  &nbsp;</label> 
														
														<input required ="true" accept = ".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,.pdf,application/pdf,application/vnd.ms-excel" class="toggle btn btn-primary" type="File" id="photo_upload" name = "photo_upload"  style="color:White; margin-left:200px; font-family: Verdana;  font-size:17px; background-color: #1163aa; border: transparent; margin-bottom: 15px;margin-bottom: 15px;">
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:250px; font-family: Verdana;  margin-top:15px; font-size:17px;">Class 10 Mark Sheet:  &nbsp;</font> 
														
														<input required ="true" accept = ".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,.pdf,application/pdf,application/vnd.ms-excel" class="toggle btn btn-primary" type="File" id="marksheet_upload" name = "marksheet_upload"  style="color:White; margin-left:200px; font-family: Verdana; font-size:17px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:195px; font-family: Verdana;  margin-top:15px; font-size:17px;">Present School Admission Document:  &nbsp;</font> 
														
														<input required ="true" accept = ".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,.pdf,application/pdf,application/vnd.ms-excel" class="toggle btn btn-primary" type="File" id="admission_document_upload" name = "admission_document_upload" value="Upload" style="color:White; margin-left:200px; font-family: Verdana; font-size:17px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:300px; font-family: Verdana;  margin-top:15px; font-size:17px;">ID Proof:  &nbsp;</font> 
														
														<input required ="true" accept = ".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,.pdf,application/pdf,application/vnd.ms-excel" class="toggle btn btn-primary" type="File" id="id_proof_upload" name = "id_proof_upload" value="Upload" style="color:White; margin-left:200px; font-family: Verdana;  font-size:17px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
													</td>
												</tr>
												<tr>
														<td>
															<input class="toggle btn btn-primary" type="submit" id="centre_sub" name = "centre_sub" value="Save & Continue" style="color:White; margin-left:270px; font-family: Verdana;  margin-top:15px; font-size:17px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
														</td>
										    	</tr>
												</table>
												</div>	
