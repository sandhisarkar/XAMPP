...
$msgNav = "";
	...
	$q_id=mysqli_query($con,"select id_proof,additioanl_number from admission_details where student_id='".$_GET["student_id"]."'");
	$n_id=  mysqli_fetch_assoc($q_id);
	
	$iden_proof = $n_id['id_proof']; 
	$iden_no = $n_id['additioanl_number']; 
	
	
	$modified_date = date("Y-m-d");
	
	$present_school = $_POST['present_school'];
	$present_board = $_POST['present_board'];
	
	$status = "Present Educational Info";
	
	 mysqli_select_db( $con,"admission_details");
	
	 $sql="UPDATE admission_details SET present_school='".$present_school."',present_board = '".$present_board."',status= '".$status."',modified_dttm='".$modified_date."' WHERE student_id='".$get_stu_ID."'";
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Admission : </h1>
										<form action="Step7Edit.php?student_id=<?php echo  $get_stu_ID?>" method="post">
											<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 50px;">
												...
												<tr>
													<td>
														...
														if($iden_proof == "Aadhar")
														{
															?>
															<input selected required="true" type="radio" checked id="id_proof" name="id_proof" value="Aadhar" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;margin-left: 150px;"><span style = "color: white;"> &nbsp; Aadhar &nbsp;</span>
															<?php
														}
														else
														{
															?>
															<input selected required="true" type="radio" id="id_proof" name="id_proof" value="Aadhar" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;margin-left: 150px;"><span style = "color: white;"> &nbsp; Aadhar &nbsp;</span>
															<?php
														}
														?>
														<?php
														if($iden_proof == "Others")
														{
															?>
															<input  type="radio" checked id="id_proof" name="id_proof" value="Others" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;margin-left: 20px;"><span style = "color: white;"> &nbsp; Others &nbsp;</span>
															<?php
														}
														else
														{
															?>
															<input  type="radio" id="id_proof" name="id_proof" value="Others" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;margin-left: 20px;"><span style = "color: white;"> &nbsp; Others &nbsp;</span>
															<?php
														}
														?>
												...
												<tr>
													<td>
														...
														<input value = "<?php echo $iden_no ?>" required="true" type="text" id="additioanl_number" name="additioanl_number"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
