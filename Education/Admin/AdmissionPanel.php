...
if(isset($_POST["centre_sub"]))
{
	...
	$q1=mysqli_query($con,"select cen_id,cen_address,cen_state,cen_pin FROM centre_details WHERE cen_name='".$cen_name."' and cen_location = '".$cen_location."'");
	...
	$cen_pin = $n1['cen_pin'];
	 ...
	 $query=mysqli_query($con ,"select MAX(id) from enquiry_details");
				...
				<div class="tab-content">
					<div class="container-fluid">
                            <div class="row">
                               ...
                               <div class="col-sm-12" style = "margin-top: -10%; margin-left: -5%;">
									<h1 style = "Color: white; margin-bottom: 25px;"> Admission : </h1>
										<form action="AdmissionPanel.php?cen_name=<?php echo  $_GET["cen_name"]?>&cen_location=<?php echo  $_GET["cen_location"]?>" method="post">
										<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 0px;">
											
												
											<table>
												<tr>
													<td><p style = "color:white;"><u>Student Information</u></p></td>
												</tr>
												...
												<tr>
													<td>
														<font style="color:White; margin-left: 64px; font-family: Verdana;  margin-top:15px; font-size:17px;">Date of Birth : &nbsp;&nbsp;&nbsp;</font> 
														<input required="true" type="date" id="student_dob" name="student_dob"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;text-transform: uppercase;">
												...
												<tr>
													<td>
														<font style="color:White; margin-left: 114px; font-family: Verdana;  margin-top:15px; font-size:17px;">Gender : &nbsp;&nbsp;&nbsp;</font> 
														<input  type="radio" id="student_gender" name="student_gender" value="Male" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;"> &nbsp; Male &nbsp;</span>
														<input  type="radio" id="student_gender" name="student_gender" value="Female" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;">&nbsp; Female &nbsp;</span>
														<input  type="radio" id="student_gender" name="student_gender" value="Other" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;">&nbsp; Other &nbsp;</span>
													</td>
												</tr>
												</table>
												</div>
												<div class="col-sm-6" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 0px;float:right;">
												<table>
												
												
												<tr>
													<td><p style = "color:white;"><u>Address</u></p></td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:36px; font-family: Verdana;  margin-top:0px; font-size:17px;">Present Address : &nbsp;&nbsp;&nbsp;</font> 
														<input type="text" id="present_address" name="present_address"  required="true" style="font-size: 15px;height: 50px;padding-top: 0px;margin-top: 0px;width: 250px;">
														
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:9px; font-family: Verdana;  margin-top:5px; font-size:17px;">Permanent Address : &nbsp;&nbsp;&nbsp;</font> 
														<input type="text" id="permanent_address" name="permanent_address"  required="true" style="font-size: 15px;height: 50px;padding-top: 0px;margin-top: 10px;width: 250px;">
												...
												<tr>
													<td>
														...
														<input type="text" id="student_phone" name="student_phone"  pattern="[0-9]{10}" maxlength="10" required="true" style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 0px;width: 250px;"><span style = "color:white;padding-left: 275px;">[Format: 9999999999]</span>
												...
												<tr>
													<td>
														...
														<input  type="email" id="student_email" name="student_email"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 0px;width: 250px;">
												...
												<tr>
													<td>
														...
														<input  type="text" id="gur_phone" name="gur_phone"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 10px;width: 250px;"><span style = "color:white;padding-left: 275px;">[Format: 9999999999]</span>
												...
												<tr>
													<td>
														...
														<input  type="text" id="past_board" name="past_board"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 0px;width: 250px;">
														
													</td>
												</tr>
												<tr>
													<td>
													<p style="color:white;">(Marks:)</p>
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:77px; font-family: Verdana;  margin-top:15px; font-size:17px;">English : &nbsp;</font> 
														<input  type="text" id="eng_marks" name="eng_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 0px;width: 70px;">
														<font style="color:White; margin-left:15px; font-family: Verdana;  margin-top:15px; font-size:17px;">Life Science : &nbsp;</font> 
														<input  type="text" id="ls_marks" name="ls_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 0px;width: 70px;">
														
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:0px; font-family: Verdana;  margin-top:15px; font-size:17px;">Physical Science : &nbsp;</font> 
														<input  type="text" id="ps_marks" name="ps_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 3px;width: 70px;">
														<font style="color:White; margin-left:8px; font-family: Verdana;  margin-top:15px; font-size:17px;">Mathematics : &nbsp;</font> 
														<input  type="text" id="math_marks" name="math_marks"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 3px;width: 70px;">
												...
												<tr>
													<td>
														<font style="color:White; margin-left: 75px; font-family: Verdana;  margin-top:15px; font-size:17px;">Aggregate : &nbsp;&nbsp;&nbsp;</font> 
														<input  type="text" id="agg" name="agg"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 10px;width: 100px;"><span style = "color:white;padding-left: 10px;">Percentage(%)</span>
												...
												<table>
												<tr>
													<td><p style = "color:white;"><u>Present Educational Information</u></p></td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:25px; font-family: Verdana;  margin-top:15px; font-size:17px;">School Name : &nbsp;&nbsp;&nbsp;</font> 
														<input  type="text" id="present_school" name="present_school"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 0px;width: 250px;">
														
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:33px; font-family: Verdana;  margin-top:15px; font-size:17px;">Board Name : &nbsp;&nbsp;&nbsp;</font> 
														<input  type="text" id="present_board" name="present_board"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;margin-bottom: 14px;">
												...
												<table>
												<tr>
													<td><p style = "color:white;"><u>Additional Information</u></p></td>
												</tr>
												<tr>
													<td>
														
														<input  type="radio" id="id_proof" name="id_proof" value="Aadhar" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;margin-left: 150px;"><span style = "color: white;"> &nbsp; Aadhar &nbsp;</span>
														<input  type="radio" id="id_proof" name="id_proof" value="Others" style="font-size: 15px;height: 5px;padding-top: 0px;margin-top: 20px;width: 5px;"><span style = "color: white;"> &nbsp; Others &nbsp;</span>
														
													</td>
												</tr>
												<tr>
													<td>
														<font style="color:White; margin-left:50px; font-family: Verdana;  margin-top:15px; font-size:17px;">ID Number : &nbsp;&nbsp;&nbsp;</font> 
														<input  type="text" id="additioanl_number" name="additioanl_number"  style="font-size: 15px;height: 25px;padding-top: 0px;margin-top: 15px;width: 250px;">
												...
												<div class="col-sm-12" style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; margin-left: 0px;">
												<table>
												<tr>
														<td>
															<input class="toggle btn btn-primary" type="submit" id="centre_sub" name = "centre_sub" value="Submit" style="color:White; margin-left:500px; font-family: Verdana;  margin-top:15px; font-size:17px; background-color: #1163aa; border: transparent; margin-bottom: 15px;">
														</td>
										    	</tr>
