            ...
            while($row1 = mysqli_fetch_row($result_op)) 
            {
                ...
                while($row2 = mysqli_fetch_row($result_result)) 
                {
                    ...
                    while($stdt <= $enddt)
                    {
                        ...
                        //$stat = "";
                        //$dt = date("Y-m-d",$stdt);
                        $q = "SELECT distinct operator_id from tbl_attendance where operator_id = '".$opid."' and created_dttm = '".$disdt."' ";
                        ...
                        {
                            $output .= '
                            <td style="background:yellow;">Absent</td>';
                            $stat = "Absent";
                        }
