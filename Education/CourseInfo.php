...
{
	$sql="Delete from course_details where course_id = '".$get_course_ID."'";

	if (!mysqli_query($con,$sql))
	{
	  //die('Error: ' . mysqli_error());
	  $msgNav = "Error in deleting the course";
    }
	else
	{
	  //echo "1 record added";
	  $msgNav = "Course is deleted successfully";
	}
}
					...
					<div class="container-fluid">
                            <div class="row" style = "width: 100%;">
                               ...
                               <div class="col-sm-12" style = "margin-top: 0%; margin-left: -3%;">
									<h1 style = "Color: white; margin-bottom: 40px;"> Course Details : </h1>
									...
									<div class="col-sm-12">
											...
											<table style="width:110%; font-size: larger;">
												<tr style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;font-size: x-large;">
													...
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Course Name</th> 
													<th style = "text-align: center; box-shadow: 0px 0px 14px #999999;border-radius:5px; color: white;">Course Price</th>
																									
												</tr>
												<?php
															mysqli_select_db( $con,"course_details");

															$sql = "SELECT course_id,course_name,course_price FROM course_details";
															...
															if (mysqli_num_rows($result) > 0) {
																...
																while($row = mysqli_fetch_assoc($result)) {
																	...
																	<td style = "padding: 5px;"><?php echo  $row["course_name"]?></td>
																	<td style = "padding: 5px;"><?php echo  $row["course_price"]?></td>
																	
																	<td style = "padding: 5px;"><a href="CourseEdit.php?course_id=<?php echo  $row["course_id"]?>"><i class="fas fa-edit" style="font-size:25px"></i></a></td>
																	<td style = "padding: 5px;"><a href="CourseInfo.php?course_id=<?php echo  $row["course_id"]?>"><i class='fas fa-trash-alt' style='font-size:25px'></a></i></td>
																	<tr>
